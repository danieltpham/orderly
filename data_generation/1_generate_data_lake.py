...
SEEDS_DIR = DATA_DIR.parent / "dbt" / "seeds"
...
def generate_canonical_brand_table():
    ...
    output_file = SEEDS_DIR / "canonical_brands.csv"
    with open(output_file, 'w', newline='', encoding='utf-8') as f:
        fieldnames = [
...
def generate_canonical_sku_catalog():
    ...
    # Write to CSV in seeds directory
    output_file = SEEDS_DIR / "canonical_sku_catalog.csv"
    with open(output_file, 'w', newline='', encoding='utf-8') as f:
        fieldnames = [
...
def generate_vendor_master_csv():
    ...
    brands = set()
    try:
        canonical_brands_file = SEEDS_DIR / "canonical_brands.csv"
...
def main():
    ...
    # # NOTE: currently commented out since in deployment, this is not usually given
    # # and needs to be generated by hand / inference models
